...
if (isset($_POST['update'])) {
    ...
    $sql = $conn->query("INSERT INTO tbl_news VALUES(NULL,'$photo_name','$judul', '$isi')");
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="judul" name="judul" placeholder="Masukkan username" value="" required>
