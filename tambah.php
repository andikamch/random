...
if (isset($_POST['update'])) {
    ...
    // Proses validasi tipe file gambar
    ...
    // Definisikan tipe file gambar yang diperbolehkan
    ...
    if (empty($judul) or empty($deskripsi) or empty($artis) or empty($image_cover) or empty($tag) or empty($film)) {
        echo'<script>alert("Harap Lengkapi Inputan")
        location.replace("");</script>';
    }
    // Query SQL untuk menyimpan data ke database
    $sql = $conn->query("INSERT INTO tbl_film VALUES(NULL, '$judul', '$deskripsi', '$artis' , '$image_cover', '$id_kategori', '$tag', '', '$user_id', NULL , '', '$film')");
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="judul" name="judul" placeholder="Masukkan judul" value="" required>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="artis" name="artis" placeholder="Masukkan produser" value="" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6 mt-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="tag" name="tag" placeholder="Masukkan tag" value="" required>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 mt-3">
                                                <div class="mb-3">
                                                    <label for="film" class="form-label fw-bold">Film :</label>
                                                    <input type="file" class="form-control" id="film" name="film" placeholder="Masukkan film" value="" required>
                                                </div>
