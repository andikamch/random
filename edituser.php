...
$id = $_GET['id'];
$films = $conn->query("SELECT * FROM tbl_user WHERE user_id='$id'");
...
if (isset($_POST['update'])) {
    ...
    // Validasi tipe ekstensi file foto
    ...
    $sql = $conn->query("UPDATE tbl_user SET username = '$username', email = '$email', password = '$password', gender = '$gender', photo = '$photo' WHERE user_id = '$id'");
    ...
    echo '<script>location.replace("kelolauser.php");</script>';
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="email" class="form-control" id="email" name="email" placeholder="Masukkan produser" value="<?= $user['email'] ?>" required>
                                                </div>
                                            </div>
                                            <div class="col-lg-12 mb-3">
                                                <label for="password" class="form-label fw-bold">password :</label>
                                                <input id="password" name="password" class="form-control" placeholder="Masukkan Password" value="<?= $user['password'] ?>">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-4">
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="col-lg-12">
                                                            <label for="photo"><img style="object-fit:cover;" src="../../../berkas/<?= $user['photo'] ?>" alt="Gambar" srcset=""></label>
