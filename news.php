...
$news = $conn->query("SELECT * FROM tbl_news");


if (isset($_POST['delete'])) {
    $id = $_POST['id'];
    $delete = $conn->query("DELETE FROM tbl_news WHERE id_news = '$id'");
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 d-md-flex flex-md-column p-3 text-white bg-dark sidebar">
                ...
                <ul class="nav nav-pills list-unstyled flex-column mb-auto">
                    ...
                    <li class="nav-item">
                        <a href="news.php" class="nav-link active text-white">
                            <svg class="bi me-2" width="16" height="16">
                                <use xlink:href="#speedometer2" />
                            </svg>
                            kelola news
            ...
            <div class="col-md-9 ms-md-auto col-lg-10 px-md-4 main-content">
                ...
                <section class="home">
                    <div class="container-fluid mt-5">
                        <div class="row mb-2">
                            <div class="col-lg-3">
                                <a class="btn btn-success w-100 mb-2" href="tambahnews.php"><i class="bi bi-plus-square"></i> Tambahkan news</a>
                            </div>
                            <div class="col-lg-9">
                                                ...
                                                foreach ($news as $row) { ?>
                                                    <tr>
                                                        ...
                                                        <td><?php
                                                            ...
                                                            echo $deskripsi;
                                                            ?></td>
                                                        <td><img src="../../../berkas/<?= $row['thumbnail_news'] ?>" style="width:200px;" srcset=""></td>
                                                        <td>
                                                            <a href="editnews.php?id=<?= $row["id_news"] ?>" style="" class="btn btn-info text-white btn-sm px-3">Edit</a>
                                                            <form action="" method="POST">
                                                                <input type="hidden" name="id" value="<?= $row["id_news"] ?>">
                                                                <button type="submit" name="delete" class="btn mt-2 btn-sm btn-danger text-white" value="<?= $row['id_news'] ?>" <?= $row['id_news'] ?>>Hapus</button>
                                                            </form>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
